...
import { InjectBot, TelegrafContextType } from "nestjs-telegraf";
...
export class BotSettingsService{
    constructor(@InjectBot('weatherUpdate') private bot: Telegraf<Context<Update>>){
    }
    async getBotDetails(res:Response){
        ...
        try {
            ...
            const about = (await bot.telegram.getMyShortDescription()).short_description;
            ...
            return res.status(500).json({
                error: 'Error in get bot details', e
            })
